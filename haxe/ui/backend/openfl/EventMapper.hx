...
class EventMapper {
    public static var HAXEUI_TO_OPENFL:Map<String, String> = [
		...
		haxe.ui.events.MouseEvent.DOUBLE_CLICK => openfl.events.MouseEvent.DOUBLE_CLICK,
    ...
    public static var OPENFL_TO_HAXEUI:Map<String, String> = [
		...
		openfl.events.MouseEvent.DOUBLE_CLICK => haxe.ui.events.MouseEvent.DOUBLE_CLICK,
